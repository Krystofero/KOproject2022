...
Moderator ma dostęp do wszystkich utworzonych ofert oraz może przejść do tworzenia nowych. Tabela posiada paginację wraz z możliwością ustalenia ilości pozycji na stronie oraz wyszukiwarką a także sortowaniem po poszczególnych kolumnach. Jest również w pełni responsywna, a kolumny które nie pomieszczą się na małym ekranie są chowane pod przyciskiem plus/minus. 
